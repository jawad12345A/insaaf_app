...
public class LawyerDeleteAppointmentAdapter extends RecyclerView.Adapter<LawyerDeleteAppointmentAdapter.MyViewHolder>{

    List<Appointment> list;
    private ListenerRegistration listener;
    private ListenerRegistration queryListener;

    public LawyerDeleteAppointmentAdapter() {
