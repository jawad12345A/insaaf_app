...
import com.example.Insaaf.Model.CancelAppointmentsClientAdapter;
...
public class CancelAppointments extends AppCompatActivity {
    ...
    private CancelAppointmentsClientAdapter adapter;
    ...
    private void getData() {
        ...
        listener = FirebaseFirestore.getInstance().collection("appointments")
                .whereEqualTo("clientPhoneNumber", SharedPreferenceHelper.INSTANCE.getContactNumber())
    ...
    private void setUpRecyclerView() {
        ...
        adapter = new CancelAppointmentsClientAdapter();
