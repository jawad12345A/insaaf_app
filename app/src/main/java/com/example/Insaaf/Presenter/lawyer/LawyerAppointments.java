...
import com.example.Insaaf.Model.LawyerAppointmentsAdapter;
...
public class LawyerAppointments extends AppCompatActivity {
    ...
    private LawyerAppointmentsAdapter adapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lawyer_appointments);
    ...
    private void setUpRecyclerView() {
        ...
        adapter = new LawyerAppointmentsAdapter();
